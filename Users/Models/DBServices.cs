...
public class DBServices
 {
     public static string connectionStr = @"workstation id=En_chanter_Karaoke.mssql.somee.com;packet size=4096;user id=Elya_Amram_SQLLogin_5;pwd=qvrs6xc9y2;data source=En_chanter_Karaoke.mssql.somee.com;persist security info=True;initial catalog=En_chanter_Karaoke;TrustServerCertificate=True";
     ...
     public static bool UpdateUser(int id, Users updatedUser)
     {
         using (SqlConnection con = new SqlConnection(connectionStr))
         {
             string query = $"UPDATE Users SET UserName = @UserName, Email = @Email, Phone = @Phone,Password = @Password, Birthday = @Birthday WHERE UserID = {id}";
